...
import { mockProductsRealistic, categories, periodOptions } from '../constants/mockData';

const TikTokRanking = () => {
    const [searchTerm, setSearchTerm] = useState('');
    const [selectedPeriod, setSelectedPeriod] = useState('日間ランキング');
    ...
    return (
        <div className="tiktok-ranking h-full p-6 shadow-sm bg-gray-300">
            {/* Header */}
            <div className="mb-6">
                {/* Filters */}
                <FilterSection
            ...
            {/* Table Header */}
            <div className="table-header-bg px-4 py-3 mb-1 rounded-t-md">
